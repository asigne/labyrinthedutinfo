...
public class PlateauJeu extends Activity {
	...
	public void annulerDernierCoup() {
		 ...
		 * pas annuler s'il a dï¿½placï¿½ son pion {
		 */
		 ...
		 * +
		 * "trouve pas oï¿½ il ï¿½tait avant, Ligne:"+(sauvPosLigne+1)+" Colonne:"
		 * +(sauvPosColonne+1)); }
		 */
	}
	...
	public void afficheICT(Case caseATraiter, ImageView imageCourante,
		 ...
		 * valeur pour la durï¿½e de la rotation dimention est la dimention des
		 * cases suivant que l'on traite le plateau ou la caseCourante
		 */
		int noImage; // numero de l'image ï¿½ affecter ï¿½ la case en cours de
		// traitement
		int noImageCourante;
	...
	public void partieFinie() {
		...
		builder.setMessage("La partie a Ã©tÃ© gagnÃ©e par \n"+ maPartie.getJoueurActif().getNom()).setCancelable(
