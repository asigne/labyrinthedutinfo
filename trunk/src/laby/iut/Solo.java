...
public class Solo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		aRegle = ArrayAdapter.createFromResource(this, R.array.regle,
		...
		aDifficulte = ArrayAdapter.createFromResource(this, R.array.difficulte,
				android.R.layout.simple_spinner_item);
		aDifficulte
		.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		...
		lancerPartie.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				/*
				 * pseudo = editPseudo.getEditableText().toString(); if
				 * (pseudo.length()==0 || pseudo.length()>10){ CharSequence text
				 * = "pseudo entre 1 et 10 caracteres"; int duration =
				 * Toast.LENGTH_SHORT; Context context =
				 * getApplicationContext(); Toast toast =
