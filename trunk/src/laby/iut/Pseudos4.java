...
public class Pseudos4 extends Activity {

	Button jouer;
	EditText pseudo1, pseudo2, pseudo3,pseudo4;
	String regle, pseudoJ1, pseudoJ2, pseudoJ3,pseudoJ4, typePartie;
	int nbJoueurs;
        ...
        jouer.setOnClickListener(new View.OnClickListener()
        {
        	public void onClick(View v)
	        	{   
	    			...
	    			pseudo4 = (EditText) findViewById(R.id.pseudoJoueur4);
	    			pseudoJ4 = pseudo4.getEditableText().toString();	
	        		if (pseudoJ1.length()==0 || pseudoJ1.length()>10 || pseudoJ2.length()==0 || pseudoJ2.length()>10 
	        				|| pseudoJ3.length()==0 || pseudoJ3.length()>10 || pseudoJ4.length()==0 || pseudoJ4.length()>10){
    ...
    public void lancerPartie() {
		...
		objetbundle.putString("pseudoJ4", pseudoJ4);
