...
public class Plateau implements Serializable, Cloneable {
	...
	public void initialisation() {
		{
			...
			PlateauCase[0][0] = new L(24, 90, 7); // bleu
			PlateauBool[0][6] = true;
			PlateauCase[0][6] = new L(26, 180, 10); // vert
			PlateauBool[6][0] = true;
			PlateauCase[6][0] = new L(27, 0, 8); // jaune
			PlateauBool[6][6] = true;
			PlateauCase[6][6] = new L(25, 270, 9); // rouge

			PlateauBool[0][2] = true;
			PlateauCase[0][2] = new T(6, 0, 1); // casque
			PlateauBool[0][4] = true;
			PlateauCase[0][4] = new T(7, 0, 2); // chandelier
			PlateauBool[6][2] = true;
			PlateauCase[6][2] = new T(16, 180, 11); // sac
			PlateauBool[6][4] = true;
			PlateauCase[6][4] = new T(17, 180, 12); // livre

			PlateauBool[2][0] = true;
			PlateauCase[2][0] = new T(8, 270, 3); // �p�e
			PlateauBool[4][0] = true;
			PlateauCase[4][0] = new T(12, 270, 7); // tetemort
			PlateauBool[2][6] = true;
			PlateauCase[2][6] = new T(11, 90, 6); // bague
			PlateauBool[4][6] = true;
			PlateauCase[4][6] = new T(15, 90, 10); // carte

			PlateauBool[2][2] = true;
			PlateauCase[2][2] = new T(9, 270, 4); // diamant
			PlateauBool[2][4] = true;
			PlateauCase[2][4] = new T(10, 0, 5); // tresor
			PlateauBool[4][2] = true;
			PlateauCase[4][2] = new T(13, 90, 8); // cl�s
			...
			for (ligne = 0; ligne < 7; ligne++) {
				for (colonne = 0; colonne < 7; colonne++) {
					if (!(PlateauBool[ligne][colonne])) {
						...
						PlateauCase[ligne][colonne] = ListCase
						.get(caseAleatoire);
	...
	public void creationListeCase() {
		// remplissage de liste de case ListCase avec les case mobiles du
		// plateau
		...
		for (int i = 0; i < comptTimage; i++) {
			rotationAleatoire = rotationAleatoire();
			ListCase.add(new T(i + 18, rotationAleatoire, i + 13)); // i+13 car
			// il y a
			// les 13
			// cases
			// fixes
	...
	public Plateau sauvPlateau() {
			...
			// plateau
		{
				...
				// plateau
			{
				...
				plateauSauv.getPlateauBool()[ligne][colonne] = plateauASauv
				.getPlateauBool()[ligne][colonne];
				// on sauvegarde le contenu du tableau PlateauCase
				plateauSauv.getPlateauCase()[ligne][colonne] = plateauASauv
				.getCase(ligne, colonne).sauvCase();
			}
		}
		return plateauSauv;
	}
